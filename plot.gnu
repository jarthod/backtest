...
set pointsize 1
set style line 1 lt 2 lc rgb "#555555" lw 1
...
plot "data/XBTEUR.csv" every 60 using 1:2:3 title 'krakenEUR' with filledcu ls 1, "positions.dat" using 1:2:3:4 title 'Short positions' with vectors arrowstyle 2, "positions.dat" using 1:5:6:7 title 'Long positions' with vectors arrowstyle 3
